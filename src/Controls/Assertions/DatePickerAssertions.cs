...
{
    private readonly ILocatorAssertions datePickerInputLocator;
    ...
    public DatePickerAssertions(
        ...
        ILocatorAssertions datePickerInputLocator)
    {
        this.rootLocatorAssertions = rootLocatorAssertions;
        this.nativeInputLocator = nativeInputLocator;
        this.datePickerInputLocator = datePickerInputLocator;
    }
    ...
    public async Task ToBeFocusedAsync(LocatorAssertionsToBeFocusedOptions? options = default)
        => await datePickerInputLocator.ToBeFocusedAsync(options).ConfigureAwait(false);
