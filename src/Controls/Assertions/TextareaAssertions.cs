...
public class TextareaAssertions : ILocatorAssertions
{
    private readonly ILocatorAssertions textareaLocator;
    private readonly ILocatorAssertions rootLocatorAssertions;

    public TextareaAssertions(
        ILocatorAssertions rootLocatorAssertions,
        ILocatorAssertions textareaLocator)
    {
    ...
    public async Task ToHaveValueAsync(string value, LocatorAssertionsToHaveValueOptions? options = default)
        => await textareaLocator.ToHaveValueAsync(value, options).ConfigureAwait(false);
