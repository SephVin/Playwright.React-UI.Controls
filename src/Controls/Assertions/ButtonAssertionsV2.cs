...
public class ButtonAssertionsV2 : ControlBaseAssertionsV2
{
    private readonly Button button;

    public ButtonAssertionsV2(Button button)
        : base(button)
    {
        this.button = button;
    }
