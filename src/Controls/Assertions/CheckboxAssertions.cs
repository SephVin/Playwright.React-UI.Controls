...
public class CheckboxAssertions : ILocatorAssertions
{
    private readonly ILocatorAssertions inputLocatorAssertions;
    private readonly ILocatorAssertions rootLocatorAssertions;

    public CheckboxAssertions(ILocatorAssertions rootLocatorAssertions, ILocatorAssertions inputLocatorAssertions)
    {
