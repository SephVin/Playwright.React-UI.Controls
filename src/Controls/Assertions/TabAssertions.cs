...
public class TabAssertions : ILocatorAssertions
{
    private readonly ILocatorAssertions rootLocatorAssertions;

    public TabAssertions(ILocatorAssertions rootLocatorAssertions)
    {
    ...
    public ILocatorAssertions Not => new TabAssertions(rootLocatorAssertions.Not);
}