...
public class RadioAssertions : ILocatorAssertions
{
    private readonly ILocatorAssertions contextAssertions;
    private readonly ILocatorAssertions inputAssertions;

    public RadioAssertions(ILocatorAssertions contextAssertions, ILocatorAssertions inputAssertions)
    {
    ...
    public ILocatorAssertions Not => new RadioAssertions(contextAssertions.Not, inputAssertions.Not);
}