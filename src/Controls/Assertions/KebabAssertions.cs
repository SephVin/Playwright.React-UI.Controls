...
{
    private readonly ILocatorAssertions captionLocatorAssertions;
    private readonly ILocatorAssertions rootLocatorAssertions;

    public KebabAssertions(ILocatorAssertions rootLocatorAssertions, ILocatorAssertions captionLocatorAssertions)
    {
        this.rootLocatorAssertions = rootLocatorAssertions;
        this.captionLocatorAssertions = captionLocatorAssertions;
    }
    ...
    public async Task ToBeHiddenAsync(LocatorAssertionsToBeHiddenOptions? options = null)
        => await captionLocatorAssertions.ToBeHiddenAsync(options).ConfigureAwait(false);
    ...
    public async Task ToBeVisibleAsync(LocatorAssertionsToBeVisibleOptions? options = null)
        => await captionLocatorAssertions.ToBeVisibleAsync(options).ConfigureAwait(false);
